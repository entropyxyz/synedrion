...
pub(crate) struct PresigningData<P: SchemeParams, I> {
    ...
    pub(crate) product_share_nonreduced: Secret<SecretSigned<<P::Paillier as PaillierParams>::Uint>>,
...
pub(crate) struct PresigningValues<P: SchemeParams> {
    pub(crate) hat_beta: Secret<SecretSigned<<P::Paillier as PaillierParams>::Uint>>,

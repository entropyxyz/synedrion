...
use crate::{
    curve::{RecoverableSignature, Scalar},
    tools::{
...
fn r1_enc_elg_0_failed() {
    ...
    check_evidence::<Override>("Protocol error: R1EncElg0Failed").unwrap();
}
...
fn r1_enc_elg_1_failed() {
    ...
    check_evidence::<Override>("Protocol error: R1EncElg1Failed").unwrap();
}
...
fn r2_wrong_ids_d() {
    ...
    check_evidence::<Override>("Protocol error: R2WrongIdsD").unwrap();
}
...
fn r2_wrong_ids_f() {
    ...
    check_evidence::<Override>("Protocol error: R2WrongIdsF").unwrap();
}
...
fn r2_wrong_ids_psi() {
    ...
    check_evidence::<Override>("Protocol error: R2WrongIdsPsi").unwrap();
}
...
fn r2_aff_g_psi_failed() {
    ...
    check_evidence::<Override>("Protocol error: R2AffGPsiFailed").unwrap();
}
...
fn r2_aff_g_hat_psi_failed() {
    ...
    check_evidence::<Override>("Protocol error: R2AffGHatPsiFailed").unwrap();
}
...
fn r2_elog_failed() {
    ...
    impl Misbehaving<Id, ()> for Override {
        ...
        fn modify_normal_broadcast(
            ...
            if round.id() == 2 {
                ...
                // So we're replacing the elog proof itself, with one incorrect value.
                ...
                message.psi_elog = ElogProof::new(
                    ...
                    ElogPublicInputs {
                        ...
                        h: &cap_y, // For the correct proof it should be `Point::GENERATOR`
                    },
                    &aux,
                );
                return NormalBroadcast::new(serializer, message);
    ...
    check_evidence::<Override>("Protocol error: R2ElogFailed").unwrap();
}
...
fn r3_elog_failed() {
    ...
    check_evidence::<Override>("Protocol error: R3ElogFailed").unwrap();
}
...
fn r4_invalid_signature_share() {
    ...
    check_evidence::<Override>("Protocol error: R4InvalidSignatureShare").unwrap();
}
...
fn r5_dec_failed() {
    ...
    check_evidence::<Override>("Protocol error: R5DecFailed").unwrap();
}
...
fn invalid_r5_messages() {
    ...
    check_evidence_with_behavior::<SP, Override, _>(
        ...
        &CheckPart::NormalBroadcast,
        &associated_data,
        "Normal broadcast error: Deserialization error",
    )
    .unwrap();
...
fn r6_dec_failed() {
    ...
    check_evidence::<Override>("Protocol error: R6DecFailed").unwrap();
}
